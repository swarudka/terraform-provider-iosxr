...
func TestAccIosxrRouterBGPNeighborGroup(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_bgp_neighbor_group.test", "address_families.0.route_policy_in", "POLICYIN"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_bgp_neighbor_group.test", "address_families.0.route_policy_out", "POLICYOUT"))
