...
func TestAccDataSourceIosxrRouterBGPNeighborGroup(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxr_router_bgp_neighbor_group.test", "address_families.0.route_policy_in", "POLICYIN"))
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxr_router_bgp_neighbor_group.test", "address_families.0.route_policy_out", "POLICYOUT"))
...
func testAccDataSourceIosxrRouterBGPNeighborGroupConfig() string {
	...
	config += `		route_policy_in = "POLICYIN"` + "\n"
	config += `		route_policy_out = "POLICYOUT"` + "\n"
	config += `	}]` + "\n"
