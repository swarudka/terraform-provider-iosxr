...
func (data *SegmentRoutingCandidatePaths) fromPlan(ctx context.Context, plan SegmentRoutingCandidatePaths) {
	data.Device = plan.Device
	data.PolicyName = types.StringValue(plan.PolicyName.ValueString())
	data.PathIndex = types.Int64Value(plan.PathIndex.ValueInt64())
}
